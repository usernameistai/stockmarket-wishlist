...
export default function StockListTable({ 
  ...
  return (
    <section>
      ...
      {/* TODO: ADD TABLE BODY */}
      <ul style={{ minHeight: "70vh" }} className="container container-md overflow-y-scroll">
        {filteredStocks.map(stock => (
          <li 
            key={stock.symbol}
            className={`grid grid-cols-4 gap-2 items-center bg-slate-900 hover:bg-gray-300
            text-white hover:text-gray-900 rounded-md px-4 py-2 
          ...
          >
            <div className="col-span-3 flex justify-between">
              <h4 
                className="font-bold course-pointer bg-teal-500 hover:bg-slate-700 text-gray-100 py-1 px-2 rounded-md"
                ...
                <>
                  <Button 
                    ...
                    onClick={() => {
                      ...
                      const newSector = prompt("Enter new sector", stock.sector);
