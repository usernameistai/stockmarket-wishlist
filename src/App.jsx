...
function App() {
  ...
  //Load and save Stocks list to local storage, Load =>
  useEffect(() => {
  ...
  const handleRemoveStock = (stockSymbol) => {
    if(window.confirm(`Are you sure you want to rmeove this stock with Symbol: ${stockSymbol}`)){
    ...
    <div className="container container-md mx-auto flex flex-col xl:flex-row gap-5 text-white bg-slate-900">
      <header className="flex flex-col mt-2">
        <div className="flex justify-between items-center">
          <h1 className="text-4xl font-bold mb-4">SM Wish List</h1>
          <TodaysDate />
        </div>
        <div 
          ref={stockWidgetRef}
